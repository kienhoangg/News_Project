...
import { AreaChartOutlined, CloudDownloadOutlined, FileAddFilled } from '@ant-design/icons';
...
function NewsStatisticsPageMenuSearch(props) {
    ...
    return (
        <div className={cx('wrapper')}>
            <Row gutter={[8, 8]}>
                <Col span={6}>
                    <Select showSearch placeholder='Cộng tác viên' style={{ width: '100%' }} allowClear={true}>
                ...
                <Col span={5}>
                    <DatePicker placeholder='Từ ngày' style={{ width: '100%' }} ref={dateStart} />
                </Col>
                <Col span={5}>
                    <DatePicker placeholder='Đến ngày' style={{ width: '100%' }} ref={dateEnd} />
                </Col>
                <Col span={6}>
                    <Button type='primary' style={{ marginLeft: 16 }} icon={<AreaChartOutlined />}>
                        Thống kê
                    </Button>
                </Col>
                <Col span={24}>
