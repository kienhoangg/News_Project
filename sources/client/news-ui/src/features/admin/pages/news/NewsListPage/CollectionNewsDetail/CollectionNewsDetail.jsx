            ...
            <Col span={20}>
              <div>{dataDetail?.IsShowComment ? 'Có' : 'Không'}</div>
                    ...
                    <Row gutter={16} className={cx('row-item')}>
                        ...
                        <Col span={20}>
                            <div>{datetimeHelper.formatDatetimeToDateVN(dataDetail?.LastModifiedDate)}</div>
                        </Col>
                    </Row>
                    <Row gutter={16} className={cx('row-item')}>
                        <Col span={4}>
                        ...
                        <Col span={20}>
                            <div>{datetimeHelper.formatDatetimeToDateVN(dataDetail?.PublishedDate)}</div>
                        </Col>
                    </Row>
                    <Row gutter={16} className={cx('row-item')}>
                        <Col span={4}>
                        ...
                        <Col span={20}>
                            <a href={imageHelper.getLinkImageUrl(dataDetail?.FilePath)}>{imageHelper?.getNameFile(dataDetail?.FilePath)}</a>
                        </Col>
                    </Row>
                </Col>
            </Row>
