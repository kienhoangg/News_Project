            ...
            onOk={() => {
                form.validateFields()
                    .then((values) => {
                        ...
                        const { category, title, IsDocumentNews, IsNewsHot, IsNewsVideo, IsDisplayTitle, IsDisplayAvatar, IsComment, avatarTitle, description, content, field, source } = values;
                        const bodyData = {
                            Title: title,
                        ...
                        if (source) {
                            bodyData.SourceNewsId = dataFilter?.sourceNews.find((x) => x?.Id === source)?.Id ?? undefined;
                        }
                        if (category) {
                            bodyData.CategoryNewsId = dataFilter?.categoryNews.find((x) => x?.Id === category)?.Id ?? undefined;
                        }
