            ...
            >
                <Form.Item label='Danh mục'>
                    <Row gutter={8}>
                        ...
                        <Col span={6}>
                            <Form.Item name='createdDate' label='Ngày tạo' style={{ marginBottom: 0 }}>
                                <DatePicker placeholder='Ngày tạo' style={{ width: '100%' }} name='createdDate' />
                            </Form.Item>
                        </Col>
                    </Row>
                </Form.Item>
                <Form.Item label='Tin nổi bật'>
                    <Row gutter={8}>
                        <Col span={4}>
                            <Form.Item style={{ marginBottom: 0 }} name='isNewsHot'>
                                <Checkbox name='isNewsHot'></Checkbox>
                            </Form.Item>
                        </Col>
                        <Col span={4}>
                            <Form.Item style={{ marginBottom: 0 }} name='isNewsVideo' label={'Tin video'}>
                                <Checkbox></Checkbox>
                            </Form.Item>
                        </Col>
                        <Col span={4}>
                            <Form.Item style={{ marginBottom: 0 }} name='isDisplayTitle' label='Hiển thị tiêu đề'>
                                <Checkbox></Checkbox>
                            </Form.Item>
                        </Col>
                        <Col span={4}>
                            <Form.Item style={{ marginBottom: 0 }} name='isDisplayAvatar' label='Hình ảnh đại diện'>
                                <Checkbox name='isDisplayAvatar'></Checkbox>
                            </Form.Item>
                        </Col>
                        <Col span={4}>
                            <Form.Item style={{ marginBottom: 0 }} name='isComment' label='Bình luận'>
                                <Checkbox name='isComment'></Checkbox>
                            </Form.Item>
                        </Col>
                    </Row>
                </Form.Item>
