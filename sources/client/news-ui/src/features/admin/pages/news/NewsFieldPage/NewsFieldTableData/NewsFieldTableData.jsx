...
function NewsFieldTableData(props) {
    ...
    const columns = [
        ...
        {
            key: 'CoefficientNumber',
            dataIndex: 'CoefficientNumber',
            title: 'Hệ số',
            render: (CoefficientNumber) => <>{CoefficientNumber}</>,
            sorter: (a, b) => a.CoefficientNumber - b.CoefficientNumber,
            width: 100,
            align: 'right',
        },
        {
            key: 'CoefficientMaxNumber',
            dataIndex: 'CoefficientMaxNumber',
            title: 'Hệ số lớn nhất',
            render: (CoefficientMaxNumber) => <>{CoefficientMaxNumber}</>,
            sorter: (a, b) => a.CoefficientMaxNumber - b.CoefficientMaxNumber,
            width: 130,
            align: 'right',
        },
        {
