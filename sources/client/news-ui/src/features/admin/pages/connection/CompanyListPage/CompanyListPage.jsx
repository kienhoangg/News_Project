...
function CompanyListPage(props) {
    ...
    const getDataFilter = async () => {
        const responseCategoryAll = linkAndCompanyApi.getCompanyInfoCategoryAll(filterAll);
    ...
    const renderStaticCategoryId = (
        <Select placeholder='Chọn danh mục' style={{ width: '100%' }} allowClear={true}>
    ...
    return (
        <div className={cx('wrapper')}>
            <Modal className={cx('modal-insert-source-news')} title='Thêm mới nguồn tin tức' open={isModalOpen} onCancel={handleCancel} footer={null}>
                <Form {...layout} form={form} name='control-hooks' onFinish={onFinish}>
                    ...
                    <Form.Item name='lb-attachment' label='Ảnh đại diện'>
                        <Upload listType='picture' defaultFileList={fileListAttachment} onChange={handleChangeAttachment} customRequest={commonFunc.dummyRequest} maxCount={1}>
