...
import styles from './ConnectionCategoryTableData.module.scss';

const cx = classNames.bind(styles);

ConnectionCategoryTableData.propTypes = {};

ConnectionCategoryTableData.defaultProps = {};

function ConnectionCategoryTableData(props) {
  const { data } = props;
...
export default ConnectionCategoryTableData;
