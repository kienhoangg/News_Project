...
RadioCategoryPage.propTypes = {};

RadioCategoryPage.defaultProps = {};
...
function RadioCategoryPage(props) {
  ...
  const handleUpdateStatus = async (values) => {
    try {
      await mediaApi.updateStatusRadioCategory({
        Ids: [values.Id],
  ...
  async function getCategoryByID(id) {
    try {
      const res = await mediaApi.getRadioCategoryByID(id);
      return res;
    } catch (err) {
      openNotification(
