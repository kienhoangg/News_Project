...
import styles from './ImageListPageSearch.module.scss';

const cx = classNames.bind(styles);

ImageListPageSearch.propTypes = {};

ImageListPageSearch.defaultProps = {};

function ImageListPageSearch(props) {
    return (
...
export default ImageListPageSearch;
