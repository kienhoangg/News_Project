        ...
        >
            {
                Array.isArray(listData) && listData.map((item) => {
                    switch (item.type) {
                        case 'date':
                            return <AdminCollectionDetailDate key={item.label} label={item.label} value={item.content} />
                        case 'datetime':
                            return <AdminCollectionDetailDateTime key={item.label} label={item.label} value={item.content} />
                        case 'image':
                            return <AdminCollectionDetailImage key={item.label} label={item.label} value={item.content} />
                        case 'text':
                        default:
                            return <AdminCollectionDetailText key={item.label} label={item.label} value={item.content} />
                    }
                })
            }
        </Modal>
