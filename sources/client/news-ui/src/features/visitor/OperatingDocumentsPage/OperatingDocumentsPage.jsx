                    ...
                    >
                        <Skeleton loading={loading} active>
                            {listNewDocument?.map((item) => (
                                <div className={cx('operating-documents-page__right__row__list-item-running__item')}>
                                    <a href={`/documents/${item?.Id}`} className={cx('operating-documents-page__right__row__list-item-running__item__href')}>
