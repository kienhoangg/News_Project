        ...
        <div className='operating-documents-detail-page'>
            ...
            <div className='operating-documents-detail-page__left'>
                <div className='operating-documents-detail-page__left__header'>
                    <div className={'operating-documents-detail-page__left__header__content'}>
                ...
                <div className='operating-documents-detail-page__left__body'>
                    <div className='operating-documents-detail-page__left__body__table'>
                        <div className='operating-documents-detail-page__left__body__table__title'>{documentDetail?.Name}</div>
                        <Skeleton loading={loading} active>
                            <table className='operating-documents-detail-page__left__body__table__content'>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Ngày ban hành</td>
                                        <td>{moment(documentDetail?.PublishedDate).format('DD/MM/YYYY')}</td>
                                    </tr>
                                    <tr>
                                        <td>Tệp đính kèm</td>
                                        <td>
                                            <a className={'operating-documents-detail-page__left__body__table__content__icon-pdf'} href={envDomainBackend + '/' + documentDetail?.FilePath}>
                                                <img
                                                    style={{
                                                        width: 20,
                                                        height: 20,
                                                    ...
                                                    alt=''
                                                />
                                                {documentDetail?.FilePath?.split('/')?.[documentDetail?.FilePath?.split('/').length - 1]}
                                            </a>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <div className='operating-documents-detail-page__left__body__list-document'>
                        <div className='operating-documents-detail-page__left__body__list-document__title'>Các văn bản khác</div>
            ...
            <div className='operating-documents-detail-page__right'>
                ...
                <div className={'operating-documents-detail-page__right__row'}>
                    ...
                    <div
                        className={'operating-documents-detail-page__right__row__list-item-running'}
                    ...
                    >
                        <Skeleton loading={loadingFilter} active>
                            {listDocuments?.map((item) => (
                                <div className={'operating-documents-detail-page__right__row__list-item-running__item'}>
                                    <a href={`/documents/${item?.Id}`} className={'operating-documents-detail-page__right__row__list-item-running__item__href'}>
                                        <span className={'operating-documents-detail-page__right__row__list-item-running__item__href__dot'}></span>
                                        <span>{item?.Name}</span>
                                    </a>
                                </div>
                            ))}
