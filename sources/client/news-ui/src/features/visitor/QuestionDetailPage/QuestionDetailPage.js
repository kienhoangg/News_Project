 ...
 */
    ...
    return <div className="question-detail-page">
        <ScrollToTop />
            ...
            <div className="question-detail-page__left__group">
                ...
                <div className="question-detail-page__left__group__list">
                    {dataQuestionMaster?.NewQuestions?.map((item) => (
                        <div className="question-detail-page__left__group__list__item" style={{cursor: "pointer"}} onClick={()=>{window.open(window.location.origin + "/questions/" + item?.Id, '_blank');}}>
        ...
        <div className="question-detail-page__right">
            ...
            <div className="question-detail-page__right__body">
                ...
                <span style={{
                    marginTop: 10,
                    fontSize: 12
                }}>{questionDetail?.QuestionContent}</span>
                ...
                <div style={{ marginTop: 10 }}>
                    {questionDetail?.AnswerContent}
                </div>

                <div style={{ marginTop: 10 }}>
                    <b><u><a  href={questionDetail?.FilePath
                        ? questionDetail?.FilePath?.indexOf("https://") === 0 ||
                            questionDetail?.FilePath?.indexOf("http://") === 0
                            ? questionDetail?.FilePath
                            : window.location.origin + questionDetail?.FilePath
                ...
                <div style={{ marginTop: 10, marginBottom: 10 }}>
                    <b>Ngày trả lời: </b> <i>{moment(questionDetail?.AnswerDate).format("DD/MM/YYYY")}</i>
                </div>
            </div>
        </div>
    </div>
